 ...
 */
protocol ALKConversationListTableViewDelegate {
...
public class ALKConversationListTableViewController: UITableViewController, Localizable {
    ...
    public var viewModel: ConversationListViewModelProtocol
     ...
     */
    init(viewModel: ConversationListViewModelProtocol, dbService: ALMessageDBService, configuration: ALKConfiguration, delegate: ALKConversationListTableViewDelegate) {
